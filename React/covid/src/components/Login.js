...
export const Login = (props) =>{
    ...
    fetch("http://127.0.0.1:8000/covid/login/",{
            method:"POST",
            headers:{
        ...
        if (data.token){
            props.fun({bool:true,username:state.username})
            ...
            <div className="w-full py-6 z-20">
                ...
                <div className="sm:w-3/3 w-full px-4 lg:px-0 mx-auto">
                    <div className="pb-2 pt-3">
                        <input type="text" name="username" id="username" placeholder="Username" onChange = {handleChange} className="block w-full p-4 text-lg rounded-sm bg-black"/>
                    </div>
                    <div className="pb-2 pt-3">
                        <input type="password" name="password" id="password" placeholder="Password" onChange = {handleChange} className="block w-full p-4 text-lg rounded-sm bg-black" />
                    </div>
                    <div className="text-right text-gray-400 hover:underline hover:text-gray-100">
                        <a href="#">Forgot your password?</a>
                    </div>
                    <div className="px-4 pb-2 pt-3">
                        <button  className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none"  onClick = {loginAPI} >sign in</button>
                    </div>
                    <div className="mx-5 pt-3 mb-1">
                      <p className=" text-white-400">
                        Not a member?
                      <a href = "#" onClick = {() => routeChange("/signup")} className="text-blue-400 ml-1 hover:underline hover:text-blue-800">
                        Sign Up
                      </a>
                      </p>
                    </div>
